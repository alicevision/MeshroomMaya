...
*	It reloads its attached QDeclarativeView whenever one of the watched source file is
*modified.
...
public:
     ...
     * @param watchSource watch the attached QDeclarativeView source file if it already has one
     * (default: False)
     ...
     * @param recursive if True, will search inside each subdirectories
     *recursively.
     */
     ...
     *  Tip: make sure to use relative or absolute path according to how you add
     * this file.
     * @param filename
     */
