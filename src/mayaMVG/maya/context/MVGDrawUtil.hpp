...
struct MVGDrawUtil
{
    ...
    static void drawLine2D(const MPoint& A, const MPoint& B, const MVector& color,
    ...
    static void drawLineLoop2D(const MPointArray& points, const MVector& color,
    ...
    static void drawPolygon2D(const MPointArray& points, const MVector& color,
    ...
    static void drawLineLoop3D(const MPointArray& points, const MVector& color,
                               const float lineWidth = 1.f, const float alpha = 1.f)
    {
        glColor4f(color.x, color.y, color.z, alpha);
        glLineWidth(lineWidth);
    ...
    static void drawPolygon3D(const MPointArray& points, const MVector& color,
                              const float alpha = 1.f)
    {
        glColor4f(color.x, color.y, color.z, alpha);
        glBegin(GL_POLYGON);
    ...
    static void drawCircle2D(const MPoint& center, const MVector& color, const int r,
                             const int segments)
    {
    ...
    static void drawEmptyCross(const float x, const float y, const float width,
                               const float thickness, const MVector& color)
    {
        glColor3f(color.x, color.y, color.z);
        glBegin(GL_LINE_LOOP);
