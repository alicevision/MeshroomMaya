...
MStatus initializePlugin(MObject obj)
{
    ...
    // register context
    status =
        plugin.registerContextCommand(MVGContextCmd::name, &MVGContextCmd::creator,
    ...
    // Maya callbacks
    _mayaCallbackIds.append(
        MEventMessage::addEventCallback("PostToolChanged", currentContextChangedCB));
    ...
    _mayaCallbackIds.append(
        MEventMessage::addEventCallback("SelectionChanged", selectionChangedCB));
    _mayaCallbackIds.append(
        MEventMessage::addEventCallback("modelEditorChanged", modelEditorChangedCB));
