...
void MVGProjectWrapper::loadABC(const QString& abcFilePath)
{
    ...
    // Set images paths
    cmd.format("from meshroomMaya import camera;\n"
...
void MVGProjectWrapper::createCameraSetFromDagPaths(const QString& name, const QStringList& paths, bool makeCurrent)
{
    ...
    set.setAnnotation("MeshroomMaya Camera Set");
    ...
    // MVGMayaCallbacks::setAddedCB does not consider it as a meshroomMaya camera set
